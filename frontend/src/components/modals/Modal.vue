<template>
    <div>
        ...
        <div
            class="fixed md:left-1/2 md:-translate-x-1/2 md:translate-y-1/2 md:bottom-1/2 md:w-[720px] md:max-w-[95%] lg:w-[960px] md:rounded-lg bottom-0 left-0 w-full rounded-t-md border-2 border-gray-700 z-50 max-h-[85vh] lg:max-h-[95vh] overflow-hidden"
