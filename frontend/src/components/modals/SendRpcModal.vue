            ...
            <div class="space-y-6">
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div v-if="stage == STAGES.PREVIEW" class="flex flex-col gap-3">
                        ...
                        <ul class="space-y-2">
                            <li v-if="deviceStore.selectedDevices.length>0" v-for="dev in deviceStore.selectedDevices" :key="dev.shellyID">
                                <DeviceWidget v-memo="[dev.shellyID]" :device-id="dev.shellyID" vertical />
                            </li>
                            <li v-else v-for="dev in deviceStore.devices" :key="dev.shellyID">
                                <DeviceWidget v-memo="[dev.shellyID]" :device-id="dev.shellyID" vertical />
                            </li>
                        </ul>
                    </div>
